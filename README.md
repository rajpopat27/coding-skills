...
- `skills/uber-go-style/` - Agent-ready Go coding and review skill based on the Uber Go Style Guide, with actionable rules, rewrite patterns, and targeted references.
