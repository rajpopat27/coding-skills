...
1. Inspect the local package, `go.mod`, nearby code, tests, and lint configuration before editing.
2. Prefer existing local conventions when they are deliberate and consistent.
